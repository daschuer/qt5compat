% qt6-5compat(SECTION) | User Commands
%
% "November 14 2021"
...
qt6-5compat - program to do something

# SYNOPSIS

**qt6-5compat** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**qt6-5compat** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **qt6-5compat** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**qt6-5compat** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    qt6-5compat. See **foo.conf**(5) for further details.
...
**qt6-5compat** provides some return codes, that can be used in scripts:
